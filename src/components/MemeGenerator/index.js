...
class MemeGenerator extends Component {
  state = {
    ...
    topTextInput: '',
    bottomTextInput: '',
    activeFontSizeOptionsId: fontSizesOptionsList[0].optionId,
    backgroundImageUrl: '',
    topText: '',
    bottomText: '',
    activeFontSizeId: '',
  ...
  onChangeFontSizeOptionsId = event => {
    this.setState({activeFontSizeOptionsId: event.target.value})
  }
  ...
  onGenerateMeme = event => {
    ...
    this.setState({
      ...
      activeFontSizeId: activeFontSizeOptionsId,
    })
  }
  ...
  renderMemeGenerator = () => {
    ...
    return (
      <MemeGeneratorForm onSubmit={this.onGenerateMeme}>
        ...
        <CustomSelect
          id="select"
          value={activeFontSizeOptionsId}
          onChange={this.onChangeFontSizeOptionsId}
        >
